...
function form(formSelector, modalSelector, modalTimerId) {
    // Form
    ...
    function showThanksModal(message) {
        ...
        (0,_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)(modalSelector, modalTimerId);
...
window.addEventListener('DOMContentLoaded', function() {  
    ...
    (0,_modules_forms__WEBPACK_IMPORTED_MODULE_1__.default)('form', '.modal', modalTimerId);
